...
Put new feature-specific coverage in test_upstream_<feature>.py modules.
Shared fixtures and comparisons live in upstream_support.py.

TSUNAGI_ANKICONNECT_CHECKOUT=/path/to/pinned/checkout python -m pytest -q tests/test_upstream_*.py
"""
